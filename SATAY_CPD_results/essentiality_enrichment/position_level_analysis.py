...
class PositionLevelAnalyzer:
    ...
    def load_segment_data(
        ...
        Path structure: SATAY_CPD_results/CPD_SATAY_results/strain_{strain}/{chrom}/{chrom}_distances/window100/merged_segments/{chrom}_th{threshold:.2f}_merged_segments_muZ{mu_z}.csv
        
        Args:
            base_path: Base path to SATAY_CPD_results/CPD_SATAY_results/
