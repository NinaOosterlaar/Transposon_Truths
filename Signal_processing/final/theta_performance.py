...
def process_theta_for_dataset(theta_value, dataset_id, data, true_cps, window_size, overlap, thresholds, 
    ...
    for threshold in thresholds:
        ...
        if algorithm == 'zinb_ref':
            ...
            change_points, scores = sliding_ZINB_CPD(
                data, window_size, overlap, threshold,
                theta_global=theta_value
            )
        elif algorithm == 'zinb_cpd_v2':
            change_points, scores = sliding_ZINB_CPD_v2(
                data, nucleosome_distances, window_size, overlap, threshold,
                theta_global=theta_value,
                nucleosome_file=nucleosome_file
            )
        elif algorithm == 'zinb_cpd_v3':
            change_points, scores = sliding_ZINB_CPD_v3(
                data, nucleosome_distances, centromere_distances, window_size, overlap, threshold,
                theta_global=theta_value,
                nucleosome_file=nucleosome_file,
