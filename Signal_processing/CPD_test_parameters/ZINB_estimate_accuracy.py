...
def plot_relative_errors(results_df):
    """
    ...
    full_output_dir = "Signal_processing/results_new/ZINB_estimation_errors"
...
def generate_zinb_datasets(sample_size=1000):
    """
...
if __name__ == "__main__":
    ...
    # Save results to CSV
    results_dir = "Signal_processing/results_new/ZINB_estimation_errors"
