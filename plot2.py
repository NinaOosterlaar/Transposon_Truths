...
recon_core = {
    "ZINB NLL": {
        "values": {
            "Train": [1.07, 0.90, 1.21, 2.82],
            "Val":   [1.10, 0.90, 1.24, 2.83],
            "Test":  [1.13, 0.92, 1.25, 2.82],
        },
        "errors": {
    ...
    r"$R^2$": {
        "values": {
            "Train": [0.90, -0.66, 0.81, 0.09],
            "Val":   [0.74, -0.66, 0.71, 0.09],
            "Test":  [0.79, -0.54, 0.71, 0.10],
        },
        "errors": {
            "Train": [0.0, 0.0, 0.0, 0.0],
            "Val":   [0.0, 0.0, 0.0, 0.0],
    ...
    "MAE": {
        "values": {
            "Train": [0.62, 8.97, 0.99, 8.28],
            "Val":   [0.79, 8.87, 1.10, 8.38],
            "Test":  [0.84, 9.11, 1.17, 8.32],
        },
        "errors": {
            "Train": [1.44, 11.24, 1.93, 13.21],
            "Val":   [2.68, 11.0, 2.75, 13.32],
            "Test":  [2.79, 11.5, 3.21, 13.32],
        },
    },
}
...
imp_core = {
    "Masked recon.": {
        "values": {
            "Train": [0.85, 13.8, 1.29, 9.45],
            "Val":   [1.06, 13.8, 1.41, 9.56],
            "Test":  [1.13, 13.5, 1.48, 9.28],
        },
        "errors": {
            "Train": [0.0, 0.0, 0.0, 0.0],
            "Val":   [0.0, 0.0, 0.0, 0.0],
    ...
    r"$R^2$": {
        "values": {
            "Train": [0.91, 0.18, 0.81, 0.082],
            "Val":   [0.76, 0.17, 0.69, 0.078],
            "Test":  [0.79, 0.019, 0.69, 0.088],
        },
        "errors": {
            "Train": [0.0, 0.0, 0.0, 0.0],
            "Val":   [0.0, 0.0, 0.0, 0.0],
    ...
    "MAE": {
        "values": {
            "Train": [0.85, 11.97, 1.29, 9.17],
            "Val":   [1.11, 12.29, 1.49, 9.31],
            "Test":  [1.19, 12.55, 1.60, 9.31],
        },
        "errors": {
            "Train": [1.46, 17.68, 2.11, 15.6],
            "Val":   [2.92, 18.48, 3.23, 15.83],
            "Test":  [3.19, 19.01, 3.78, 15.62],
        },
    },
}
...
recon_params = {
    r"$\pi$ zeros": {
        "values": {
            "Train": [0.0, 0.84, 0.0, 0.14],
            "Val":   [0.0, 0.84, 0.0, 0.14],
            "Test":  [0.0, 0.83, 0.0, 0.14],
        },
        "errors": {
            "Train": [0.0, 0.15, 0.0, 0.0002],
            "Val":   [0.0, 0.15, 0.0, 0.0002],
            "Test":  [0.0, 0.16, 0.0, 0.0002],
        },
    },
    r"$\pi$ non-zeros": {
        "values": {
            "Train": [0.0, 0.59, 0.0, 0.14],
            "Val":   [0.0, 0.59, 0.0, 0.14],
            "Test":  [0.0, 0.58, 0.0, 0.14],
        },
        "errors": {
            "Train": [0.0, 0.23, 0.0, 0.0003],
            "Val":   [0.0, 0.23, 0.0, 0.0003],
            "Test":  [0.0, 0.23, 0.0, 0.0003],
        },
    },
    r"$\mu$ zeros": {
        "values": {
            "Train": [0.0831, 8.33, 0.25, 6.56],
            "Val":   [0.0847, 8.33, 0.25, 6.60],
            "Test":  [0.0840, 8.42, 0.26, 6.42],
        },
        "errors": {
            "Train": [0.27, 9.11, 0.71, 6.22],
            "Val":   [0.27, 9.11, 0.73, 6.17],
            "Test":  [0.27, 9.11, 0.74, 6.60],
        },
    },
    r"$\mu$ non-zeros": {
        "values": {
            "Train": [3.24, 12.01, 3.01, 7.26],
            "Val":   [3.35, 12.06, 3.02, 7.41],
            "Test":  [3.59, 12.60, 3.24, 7.47],
        },
        "errors": {
            "Train": [5.92, 10.48, 4.72, 4.81],
            "Val":   [6.98, 10.48, 5.15, 4.87],
            "Test":  [7.37, 10.99, 5.54, 5.06],
        },
    },
    r"$\theta$": {
        "values": {
...
imp_params = {
    r"$\pi$": {
        "values": {
            "Train": [0.0, 0.60, 0.0, 0.14],
            "Val":   [0.0, 0.60, 0.0, 0.14],
            "Test":  [0.0, 0.58, 0.0, 0.14],
        },
        "errors": {
            "Train": [0.0, 0.23, 0.0, 0.0003],
    ...
    r"$\mu$": {
        "values": {
            "Train": [3.06, 12.07, 3.02, 7.27],
            "Val":   [3.11, 11.90, 3.305, 7.41],
            "Test":  [3.35, 12.44, 3.27, 7.47],
        },
        "errors": {
            "Train": [5.50, 11.16, 4.80, 4.81],
            "Val":   [6.29, 10.3, 5.23, 4.87],
            "Test":  [6.81, 10.79, 5.62, 5.06],
        },
    },
    r"$\theta$": {
        "values": {
