...
#SBATCH --output=slurm_train_all_chr_%j.out
#SBATCH --error=slurm_train_all_chr_%j.err

set -euo pipefail

echo "Training ZINBAE model on all chromosomes"
